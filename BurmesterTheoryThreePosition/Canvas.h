...
namespace canvas {
	...
	public:
		...
		void calculateSolutions(int linkage_type, int num_samples, std::vector<std::pair<double, double>>& sigmas, bool avoid_branch_defect, bool rotatable_crank, double position_error_weight, double orientation_error_weight, double trajectory_weight, double size_weight);
